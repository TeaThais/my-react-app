...
const profileReducer = (state=initialState, action) => {
    ...
    switch (action.type) {
        ...
        case ADD_POST: {
            ...
            stateCopy.profilePage.postItems = {...state.profilePage.postItems}
